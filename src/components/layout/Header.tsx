          ...
          <nav className="hidden md:flex items-center gap-8">
            {navLinks.map((link, index) => (
                ...
                >
                  <Link
                    to={link.path}
                    className={cn('relative text-lg leading-7 font-light tracking-wide transition-colors duration-300', isTransparent ? 'text-white hover:text-white/80' : 'text-foreground hover:text-muted-foreground')}
                  >
                    {link.name}
                    {/* Active underline */}
