...
import { Calendar, Code2, ExternalLink, Github, Layers, MapPin } from 'lucide-react';
        ...
        >
          ...
          {(project.github || project.live) && (
            <div className="flex flex-wrap gap-3 border-t border-border pt-8">
              {project.github && <a href={project.github} target="_blank" rel="noreferrer" className="inline-flex items-center gap-2 bg-foreground px-5 py-3 text-sm font-medium text-background transition-opacity hover:opacity-85"><Github className="size-4" /> View source code</a>}
              {project.live && <a href={project.live} target="_blank" rel="noreferrer" className="inline-flex items-center gap-2 border border-border px-5 py-3 text-sm font-medium transition-colors hover:bg-muted"><ExternalLink className="size-4" /> Open live project</a>}
            </div>
          )}
        </motion.div>
      </section>
